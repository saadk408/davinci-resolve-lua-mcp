...
Only the latest release is supported. A fix ships as a new `.mcpb` on the Releases page; extensions installed from a file do not update on their own, so reinstall to get it.
